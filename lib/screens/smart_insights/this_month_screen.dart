...
class SmartInsightsThisMonthScreen extends StatefulWidget {
  const SmartInsightsThisMonthScreen({
    super.key,
  ...
  static Future<void> push(
    ...
    return Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => SmartInsightsThisMonthScreen(
  ...
  @override
  State<SmartInsightsThisMonthScreen> createState() =>
      _SmartInsightsThisMonthScreenState();
}

class _SmartInsightsThisMonthScreenState
    extends State<SmartInsightsThisMonthScreen> {
  @override
  void initState() {
    super.initState();
            ...
            child: ListView(
              ...
              children: [
                ...
                if (snapshot.topInsights.isNotEmpty) ...[
                  SmartAnalyticsTopInsightsCard(insights: snapshot.topInsights),
                  const SizedBox(height: AppSpacing.section),
                ],
                SmartAnalyticsThisMonthSection(overview: snapshot.thisMonth),
              ],
            ),
          ),
        ),
